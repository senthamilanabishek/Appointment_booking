...
import logo from "../../assets/images/logo.png"; // Assuming the path is correct

import { RiLinkedinFill } from "react-icons/ri"; // 2.3k (gzipped: 1.1k)
import { AiFillYoutube, AiFillGithub, AiOutlineInstagram } from "react-icons/ai"; // 4.5k (gzipped)

// Corrected socialLinks array
const socialLinks = [
  {
