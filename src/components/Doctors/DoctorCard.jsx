...
import { BsArrowRight } from "react-icons/bs"; // Assuming you still want this icon
...
<div className="relative overflow-hidden w-[300px] h-[300px] rounded-lg shadow-lg hover:shadow-2xl transition-shadow">
  <img
    src={photo}
  ...
  />
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        ...
        lg:tex-[16px] lg:leading-7 font-semibold rounded">
          {specialization}
        </span>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        <div >
          ...
          <p className="text-[14px] leading-6 font-[400] text-textColor">
            At {experiences && experiences[0]?.hospital || "No hospital available"}
          </p>
        </div>

        <Link to={`/doctors/${doctor._id}`}
        className='w-[44px] h-[44px] rounded-full border border-solid 
        border-[#181A1E] flex items-center justify-center group
