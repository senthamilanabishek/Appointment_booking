...
const Login = () => {
  ...
  return (
    <section className='w-full max-w-[570px] mx-auto rounded-lg shadow-md md:p-10 '>
      ...
      <form className="py-4 md:py-0" onSubmit={submitHandler}>
        <div className="mb-5">
          ...
          className='w-full py-3 border-b border-solid border-[#00^^ff61] focus:outline-none
        ...
        <div className="mt-7">
          ...
          className='w-full bg-primaryColor text-white text-[18px] leading-[30px] rounded-lg px-4 py-3'>
            {loading ? <HashLoader size={32} color='#fff'/> : 'Login'}
          </button>
        </div>
