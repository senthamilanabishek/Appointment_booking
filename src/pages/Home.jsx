...
const Home = () => {
  return (
    <>
      {/* ________Hero Section_____________ */}
      <>
      <section className='hero__section pt-[60px] 2xl:h-[800px] '>
        <div className="container">
          <div className='flex flex-col lg:flex-row gap[90px] items-center justify-between'>
            {/* __________Hero Content_________ */}
            <div>
              <div className='lg:w-[570px] '>
                ...
                <p className='text_para'>
                  ...
                  Labore cupiditate, obcaecati veritatis consectetur reprehenderit, molestiae voluptates
                  exercitationem voluptatum tempore velit libero nesciunt sint saepe! Laborum odio.
                </p>
            ...
            {/* __________hero Content____________ */}
      ...
      {/* __________________hero section ends __________________  */}
      </>
              ...
              <div className='py-[30px] px-5 '>
                 ...
                 <div className="mt-[30px]">
                  ...
                  <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                    World-class care for everyone. Our health System Offers unMatched, export health care. From the lab to Clinic.
                  </p>
      ...
      {/* ________________about Setion start________________ */}
       <About/>
      {/* ________________about Setion end________________ */}


      {/* __________________service section start________________ */}
      <section>
        <div className="container">
      ...
      {/* __________________service section end________________ */}

      {/* ____________feature Section__________ */}
      <section>
        <div className="container">
          <div className="flex items-center justify-between flex-col lg:flex-row ">
            {/* ________feature content________ */}
            <div className="xl:w-[670px]">
              <h2 className='heading'>Get Virtual treatment <br/>  anytime.</h2>
              <ul className='pl-4'>
                <li className='text_para'> 1.Schedule the appointment directly.</li>
                <li className='text_para'>2.Search for you physician here, and contact their office.</li>
            ...
            {/* _________feature img__________ */}
            <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0 '>
              ...
              md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px] '>
                <div className='flex items-center justify-between '>
                  ...
                  <span className='w-5 lg:w-[34px] lg:h-[34px] flex items-center justify-center
                  bg-yellowColor py-1 px-[6px] lg:py-3 lg:px-[9px]'>
                ...
                [8px] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor font-[500] 
      ...
      {/* ____________feature Section end__________ */}

    {/* ____________our great doctors________ */}
    ...
    <section>
      ...
      {/* ________________faq section starts________________ */}
        <section>
          <div className='container'>
            <div className='flex justify-between gap-[50px] lg:gap-0'>
              <div className='w-1/2 hidden md:block'><img src={faqImg}></img></div>
      ...
      {/* ________________faq section end________________ */}


      {/* _______________testimonial start_______________ */}
         <section>
          <div className="container">
            <div className='xl:w-[470px] mx-auto'>
      ...
      {/* _______________testimonial end_______________ */}
