...
const Signup = () => {
  ...
  const handleFileInputChange= async event=>
  {
   ...
   //later we aill use cloudinary to upload images.
    console.log(file);
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          <div className="hidden lg:block bg-primaryColor rounded-l-lg">
            <figure className='rounded-l-lg'>
              <img src={signupImg} alt="no img found" className='w-full rounded-l-lg'/>
            </figure>
          </div>

          {/* _____________signup form__________ */}
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              <div className="mb-5">
                ...
                className='w-full pr-4 py-3 border-b border-solid border-[#00^^ff61] focus:outline-none
