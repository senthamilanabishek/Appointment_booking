...
useEffect(()=>
    ...
    const handleFileInputChange =async event =>{
        ...
        if (data?.url) {
        const updatedFormData = { ...formData, photo: data.url };
        setFormData(updatedFormData);

        // Update the local storage
        const updatedDoctorData = { ...doctorData, photo: data.url };
    ...
    const addQualification=e=>
    {
        ...
        addItem('qualifications',{
            startingDate:'',endingDate:'', degree:'PHD', university:'Applo Medical college'
        })
    } 
